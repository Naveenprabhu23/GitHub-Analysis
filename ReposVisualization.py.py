...
data=pd.read_csv('F:\\project\\Data set\\ReposData.csv',encoding='latin-1')
data['Created_at']
#print(data)
#date=data.iloc[:,2]
#print(date)
...
def year_wise_lang_visual(parameter):
        for i in data['Language']:
            if (parameter == i):
                ...
                lang.unstack()[parameter].plot(kind='barh',color="orange",fontsize=13,figsize=(20,5))#.bar(figsize=(20,5))
